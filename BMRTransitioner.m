...
static NSString *kErrorImplementationInChildren = @"Please, be aware you need to implement the full transitions in your children classes";

/******************************************************************************************/

@implementation BMRTransitioner

- (void)executePresentationWithContext:(id<UIViewControllerContextTransitioning>)transitionContext
                              duration:(NSTimeInterval)duration
{
    NSAssert(NO, kErrorImplementationInChildren);
}
